...
import 'routes/input_focus.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: <Widget>[
        ...
        new Container(
          child: new GestureDetector(
            child: Text("图片加载及Icon",
                style: TextStyle(fontSize: 18.0, color: Colors.blue)),
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => ImageAndIconRoute()));
            },
          ),
        ),
        new Container(
          child: GestureDetector(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => RadioAndCheckboxRoute()));
            },
          ),
        ),
        new Container(
          child: GestureDetector(
            ...
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => InputAndFormRoute()));
            },
          ),
        ),
        new Container(
            child: GestureDetector(
                ...
                onTap: () {
                  MaterialPageRoute(builder: (context) => FocusRoute());
                })),
      ]),
    );
  }
